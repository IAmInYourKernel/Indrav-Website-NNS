    ...
    <section id ="home" 
     className="min-h-screen flex flex-col justify-center items-center text-white px-4 pt-20"
      ...
      <p className="text-center max-w-2xl text-gray-300 mb-8">
       At Indrav, we drive healthcare change through the fusion of people and technology. <br /> Based in India, we create digital health solutions that enhance accessibility and <br /> efficiency, empowering everyone to shape a healthier future.
      </p>
